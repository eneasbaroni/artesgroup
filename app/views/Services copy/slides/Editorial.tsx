...
const EditorialSlide = ({
  ...
  return (
    <motion.div
      id="editorial"
      className="w-full h-screen px-10 sticky top-0 flex items-center justify-center flex-col bg-[url('/images/Editorial.png')] bg-cover bg-center"
      style={{ scale, borderRadius, rotate }}
    >
      <div className="max-w-170 text-center darker-glass p-10 rounded-4xl border border-white/10">
        <h3 className="font-anton text-[40px] mobile:text-3xl">EDITORIAL</h3>
